...
import member.controller.AddMemberActionListener;
 ...
 */
public class AddMemberData extends JPanel{
	...
	public AddMemberData(MemberAndDonatorFrame frame, AddMember amember, ManageMembers managem, Member associationMember, KassenBuch moneyBook, AssociationDataTransfer adatatrans){
		...
		this.association_member = associationMember;
		this.association_data_transfer = adatatrans;
		this.money_book = moneyBook;
		...
		next_button.addActionListener(new AddMemberActionListener(this, association_member, money_book, association_data_transfer));
	...
	public void buildPanel(){
		...
		//setBorder(new TitledBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.LIGHT_GRAY ), "Mitgliederdaten"));
		setOpaque(false);
		
		memberpanel = new JPanel();
		memberpanel.setBorder(new TitledBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.LIGHT_GRAY ), "Mitgliedsdaten"));
