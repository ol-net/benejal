 ...
 * Jeder Satz wird in einer eigenen logischen Datei abgelegt
 * @author Artem Petrov
 *
 */
public class DTAprinter2 implements BankOrderWriter {
	 ...
	 */
	public DTAprinter2(Account account, Date date) {
...
//				opened = false;
	...
	private void addCSatz(Payment p) throws DtausException, IOException {
