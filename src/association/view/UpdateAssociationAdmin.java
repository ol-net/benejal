...
/**
 * gui-class represent update panel for administration
 * 
 * @author Leonid Oldenburger
 */
public class UpdateAssociationAdmin extends RegisterAssociationAdmin{
	 ...
	 * @param adatatrans
	 */
	public UpdateAssociationAdmin(ConfigFrame mFrame, Association aObject, KassenBuch moneyBook, AssociationDataTransfer adatatrans){
		...
		setBorder(new TitledBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.LIGHT_GRAY ), "Vereinsleitung"));
		
		buildPanel();
		// Buttons
		save_button = new ButtonDesign("images/save_icon.png");
		back_button = new ButtonDesign("images/mainmenu_icon.png");
		save_button.addActionListener(new AssociationAdminActionListener(this, mainFrame, association_object, money_book, association_data_transfer));
