...
/**
 * gui-class represent update panel configuration
 * 
 * @author Leonid Oldenburger
 */
public class UpdateAssociationConfig extends RegisterAssociationConfig{
	 ...
	 * @param adatatrans
	 */
	public UpdateAssociationConfig(ConfigFrame mFrame, Association aObject, KassenBuch moneyBook, AssociationDataTransfer adatatrans){
		...
		setBorder(new TitledBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.LIGHT_GRAY ), "Vereinskonfiguration"));
		...
		save_button.addActionListener(new AssociationConfigActionListener(this, mainframe, association_object, money_book, association_data_transfer));
